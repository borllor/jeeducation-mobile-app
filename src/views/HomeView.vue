...
import bgLight from '@/assets/img/home-backgroud-light-bg.png'
import brandLogo from '@/assets/img/jeeducation-icon.png'
import welcomeNameIcon from '@/assets/img/home-welcome-name-icon.png'
import welcomeGreatIcon from '@/assets/img/home-welcome-great-icon.png'
import gotoJetreeBtn from '@/assets/img/goto-jetree-button.png'
import clIcon from '@/assets/img/home-current-lesson-icon.png'
import clCourseIcon from '@/assets/img/home-current-lesson-course-icon.png'
import clYearIcon from '@/assets/img/home-current-lesson-year-icon.png'
import clWeekIcon from '@/assets/img/home-current-lesson-week-icon.png'
import clTermIcon from '@/assets/img/home-current-lesson-term-icon.png'
import clNameIcon from '@/assets/img/home-current-lesson-name-icon.png'
import learningIcon from '@/assets/img/home-current-learning-icon.png'
import replayAImg from '@/assets/img/replay-a-icon.png'
import replayBImg from '@/assets/img/replay-b-icon.png'
import homeworkImg from '@/assets/img/homework-icon.png'
import homeworkAnswersImg from '@/assets/img/homework-anwers-icon.png'
import extraFoundationImg from '@/assets/img/extra-foundation-icon.png'
import extraDevelopmentImg from '@/assets/img/extra-development-icon.png'
import extraEnrichmentImg from '@/assets/img/extra-enrichment-icon.png'
import revisionExerciseImg from '@/assets/img/revision-exercise-icon.png'
import weeklyReportIcon from '@/assets/img/home-weekly-report-icon.png'
import revisionIcon from '@/assets/img/home-weekly-report-revision-icon.png'
import weeklyHomeworkIcon from '@/assets/img/home-weekly-homework-icon.png'
...
async function handleUnlock(lesson, itemId, linkText, isExtra) {
  ...
  try {
    ...
    if (res?.code === '200' && res?.result) {
      ...
      showToast({ message: 'Not enough points.', type: 'fail' })
    } else {
