...
import bgLight from '@/assets/img/jetree-light-bg.png'
import brandLogo from '@/assets/img/jeeducation-icon.png'
import pointsIcon from '@/assets/img/points-icon.png'
import sprigImg from '@/assets/img/your-learning-path-icon.png'
import returnIcon from '@/assets/img/return-to-current-lesson-icon.png'
import typeSelIcon from '@/assets/img/lesson-type-icon.png'
import yearSelIcon from '@/assets/img/year-select-icon.png'
import termSelIcon from '@/assets/img/term-select-icon.png'
import lockIconImg from '@/assets/img/lock-icon.png'
import unlockIconImg from '@/assets/img/unlock-icon.png'
import halfLockIconImg from '@/assets/img/half-lock-icon.png'
import lockBgImg from '@/assets/img/lock-icon-bg.png'
import unlockBgImg from '@/assets/img/unlock-icon-bg.png'
import halfLockBgImg from '@/assets/img/half-lock-icon-bg.png'
